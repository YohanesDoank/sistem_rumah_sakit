...
use backend\modules\ranap\models\PendaftaranSearch;
...
class PendaftaranController extends Controller
{
    ...
    public function actionGetNameRanjang($kode_ranap)
    {
        $ranap = Pendaftaran::findOne($kode_ranap);
        echo Json::encode($ranap);
