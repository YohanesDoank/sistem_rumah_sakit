...
use backend\modules\ranap\models\DokterSearch;
...
class DokterController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->kode_dokter]);
        } else {
    ...
    public function actionGetNameDoctor($kode_dokter)
    {
        $dokters = Dokter::findOne($kode_dokter);
        echo Json::encode($dokters);
