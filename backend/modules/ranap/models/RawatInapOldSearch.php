...
/**
 * RawatInapOldSearch represents the model behind the search form about `backend\modules\ranap\models\RawatInapOld`.
 */
class RawatInapOldSearch extends RawatInapOld
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['kode_ranjang', 'tanggal_pendaftaran', 'tanggal_keluar'], 'safe'],
            [['uang_dp'], 'number'],
        ];
    }
