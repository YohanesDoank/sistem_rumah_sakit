...
$this->title = 'Sistem Informasi Rumah Sakit - Rawat Inap';
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
                ...
                $command = $connection->createCommand('SELECT count(*) FROM ranap_rawat_inap'); 
            ...
            <a href='index.php?r=ranap%2Fpendaftaran' class="small-box-footer">Lihat lebih <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
