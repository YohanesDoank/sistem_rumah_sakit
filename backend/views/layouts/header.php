...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">RS</span><span class="logo-lg"><span class="fa fa-hospital-o"></span> Rumah Sakit</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= $directoryAsset ?><?php echo $gambar; ?>" class="user-image" alt="User Image"/>
